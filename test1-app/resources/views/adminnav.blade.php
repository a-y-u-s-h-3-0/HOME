        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="/category"> <i class="menu-icon fa fa-dashboard"></i>Category </a>
                    </li>
                    <li class="">
                        <a href="/product"> <i class="menu-icon fa fa-dashboard"></i>Product </a>
                    </li>
                    <li class="">
                        <a href="/orders"> <i class="menu-icon fa fa-dashboard"></i>Order </a>
                    </li>
                    <li class="">
                        <a href="/users"> <i class="menu-icon fa fa-dashboard"></i>User </a>
                    </li>
                    <li class="">
                        <a href="/login"> <i class="menu-icon fa fa-dashboard"></i>Logout </a>
                    </li>
